...
want available across many tasks rather than triggered by one keystroke. The resolution surface: Skills resolve via /skill-name; reusable packaged capabilities.
