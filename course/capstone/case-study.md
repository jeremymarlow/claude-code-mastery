...
| [Reviewer subagent panel](../../.claude/agents/) | 11 fenced subagents (10 critique personas + 1 no-persona control) that read the build's own transcripts and each write an independent evaluation (the [collaboration retrospective](../case-studies/collaboration-retrospective.md)). | [Subagents](../units/13-subagents/unit.md) |
