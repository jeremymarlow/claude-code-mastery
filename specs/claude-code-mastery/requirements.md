...
## 8. Traceability
Each requirement ID (`R1`–`R15`) will be referenced by the corresponding component(s) in `design.md` and by tasks in `tasks.md`. No requirement may be dropped without an explicit, recorded decision.
