...
**Version currency.** Verified against Claude Code {{vd:_verified_version}}. The inline flag form,
...
- The flags, the subcommand, and on-disk format: {{vd:subagents}} Version-specifics in
